...
<head>
	...
	<!-- Magnific Popup -->
    <link rel="stylesheet" href="{{url('backend/css/magnific-popup.min.css')}}">
	<!-- Font Awesome -->
    <link rel="stylesheet" href="{{url('backend/css/font-awesome.css')}}">
	<!-- Fancybox -->
	<link rel="stylesheet" href="{{url('backend/css/jquery.fancybox.min.css')}}">
	<!-- Themify Icons -->
    <link rel="stylesheet" href="{{url('backend/css/themify-icons.css')}}">
	<!-- Nice Select CSS -->
    <link rel="stylesheet" href="{{url('backend/css/niceselect.css')}}">
	<!-- Animate CSS -->
    <link rel="stylesheet" href="{{url('backend/css/animate.css')}}">
	<!-- Flex Slider CSS -->
    <link rel="stylesheet" href="{{url('backend/css/flex-slider.min.css')}}">
	<!-- Owl Carousel -->
    <link rel="stylesheet" href="{{url('backend/css/owl-carousel.css')}}">
	<!-- Slicknav -->
    <link rel="stylesheet" href="{{url('backend/css/slicknav.min.css')}}">
	
	<!-- Eshop StyleSheet -->
	<link rel="stylesheet" href="{{url('backend/css/reset.css')}}">
...
<body class="js">
    ...
    <script src="{{url('backend/js/jquery-migrate-3.0.0.js')}}"></script>
	...
	<!-- Color JS -->
	<script src="{{url('backend/js/colors.js')}}"></script>
	<!-- Slicknav JS -->
	<script src="{{url('backend/js/slicknav.min.js')}}"></script>
	<!-- Owl Carousel JS -->
	<script src="{{url('backend/js/owl-carousel.js')}}"></script>
	<!-- Magnific Popup JS -->
	<script src="{{url('backend/js/magnific-popup.js')}}"></script>
	<!-- Waypoints JS -->
	<script src="{{url('backend/js/waypoints.min.js')}}"></script>
	<!-- Countdown JS -->
	<script src="{{url('backend/js/finalcountdown.min.js')}}"></script>
	<!-- Nice Select JS -->
	<script src="{{url('backend/js/nicesellect.js')}}"></script>
	<!-- Flex Slider JS -->
	<script src="{{url('backend/js/flex-slider.js')}}"></script>
	<!-- ScrollUp JS -->
	<script src="{{url('backend/js/scrollup.js')}}"></script>
	<!-- Onepage Nav JS -->
	<script src="{{url('backend/js/onepage-nav.min.js')}}"></script>
	<!-- Easing JS -->
	<script src="{{url('backend/js/easing.js')}}"></script>
	<!-- Active JS -->
	<script src="{{url('backend/js/active.js')}}"></script>
</body>
</html>