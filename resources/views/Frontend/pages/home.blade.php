                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                ...
                                                <div class="product-content">
                                                    <h3><a
                                                            href="product-details.html">{{ $data->product_name }}</a>
                                                    </h3>
                    ...
                    @foreach ($category as $data)
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                <a href="product-details.html">
                                    <img class="default-img"
                                        src="{{ url('/uploads/category/' . $data->image) }}" alt="">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body"style="padding:30px;">
            ...
            <input name="customer_name" type="text" class="form-control" id="name" placeholder="Enter name">
             ...
             <input name="customer_email" type="email" class="form-control" id="email"placeholder="Enter email">
             <label for="number">Phone Number</label>
             <input name="phone_number" type="tel" class="form-control" id="number"placeholder="Enter your phone number">
             <label for="password">Password</label>
             <input name="customer_password" type="password" class="form-control" id="email"placeholder="customer_password">
        </div>
