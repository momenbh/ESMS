                                                ...
                                                <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                                    <div class="single-product">
                                                        <div class="product-img">
                                                            <a href="product-details.html">
                                                                <img class="default-img"
                                                                    src="{{ url('/uploads/' . $data->image) }}" alt="#">
                                                                <img class="hover-img"
                                                                    src="{{ url('/uploads/' . $data->image) }}" alt="#">
                                                            </a>
                                                            <div class="button-head">
                                                                <div class="product-action">
                                                                    <a 
                                                                        title="Quick View" href="{{route('customer.product.view',$data->id)}}"><i
                                                                            class=" ti-eye"></i><span>View detail</span></a>
                                                        ...
                                                        <div class="product-content">
                                                            <h3><a href="product-details.html">{{ $data->product_name }}</a>
                                                            </h3>
                        ...
                        <div class="owl-carousel popular-slider">
                            ...
                            @foreach ($category as $data)
                                ...
                                <div class="single-product">
                                    <div class="product-img">
                                        <a href="product-details.html">
                                            <img class="default-img" src="{{ url('/uploads/category/' . $data->image) }}"
                                                alt="">
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('registration') }}"method="post"enctype="multipart/form-data">
                        ...
                        <div class="modal-body"style="padding:30px;">
                            ...
                            <input name="customer_name" type="text" class="form-control" id="name"
                            ...
                            <input name="customer_password" type="password" class="form-control"
                                id="email"placeholder="customer_password">
                        </div>
