                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            ...
                            @else
                                ...
                                <li><i class="fa-solid fa-id-card"></i> <a href=""data-bs-toggle="modal"
                                        data-bs-target="#registration">Registration</a></li>
                            </ul>
                        @endauth
                    </div>
                    <!-- End Top Right -->
                                ...
                                <div class="navbar-collapse">
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li><a href="#">CATEGORIES<i class="ti-angle-down"></i><span
