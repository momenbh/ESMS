												...
												<div class="single-product">
													<div class="product-img">
														<a href="product-details.html">
															<img class="default-img" src="{{url('/uploads/'.$data->image)}}" alt="#">
													...
													<div class="product-content">
														<h3><a href="product-details.html">{{$data->product_name}}</a></h3>
                ...
                <div class="col-12">
                    <div class="owl-carousel popular-slider">
						...
						<div class="single-product">
							<div class="product-img">
								<a href="product-details.html">
									<img class="default-img" src="{{url('/uploads/category/'.$data->image)}}" alt="">
